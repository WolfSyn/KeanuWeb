  ...
  return (
    <div className="min-h-screen text-slate-800 bg-gradient-to-br from-[var(--ktech-50)] via-white to-[var(--ktech-100)]">
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/80 backdrop-blur-md">
        {/* Taller header so the bigger logo has room */}
        <div className="mx-auto max-w-7xl h-24 sm:h-28 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          {/* BRAND: image only (served from public/img/KtechAI.png) */}
          <a href="#home" className="shrink-0 flex items-center" aria-label="KtechAI home">
            <img
              src="/img/KtechAI.png?v=2"        // absolute path from public/ (+cache-bust)
              alt="KtechAI"
